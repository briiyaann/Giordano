<?php /* Smarty version 2.6.18, created on 2014-09-26 11:44:29
...
<!-- This file is used to display the fields based on the ui type in detailview -->
 ...
 width=25% class="dvtCellInfo" align="left">&nbsp;
...
?>
		...
		<?php elseif ($this->_tpl_vars['keyid'] == '14'): ?><!--Time-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=25% class="dvtCellInfo" align="left">&nbsp;<?php echo $this->_tpl_vars['keyval']; ?>

			</td>
		<?php elseif ($this->_tpl_vars['keyid'] == '17'): ?> <!--WebSite-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=25% class="dvtCellInfo" align="left">&nbsp;<a href="<?php echo $this->_tpl_vars['keyval']; ?>
" target="_blank"><?php echo $this->_tpl_vars['keyval']; ?>
</a>
			</td>
		<?php elseif ($this->_tpl_vars['keyid'] == '85'): ?><!--Skype-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=25% class="dvtCellInfo" align="left" id="mouseArea_<?php echo $this->_tpl_vars['label']; ?>
">
...
?call"><?php echo $this->_tpl_vars['keyval']; ?>
		...
		<?php elseif ($this->_tpl_vars['keyid'] == '19' || $this->_tpl_vars['keyid'] == '20'): ?> <!--TextArea/Description-->
			...
			<?php endif; ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=100% class="dvtCellInfo" align="left">&nbsp;
		...
		<?php elseif ($this->_tpl_vars['keyid'] == '21' || $this->_tpl_vars['keyid'] == '24' || $this->_tpl_vars['keyid'] == '22'): ?> <!--TextArea/Street-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=25% class="dvtCellInfo" align="left">&nbsp;<span id ="dtlview_<?php echo $this->_tpl_vars['label']; ?>
"><?php echo $this->_tpl_vars['keyval']; ?>
</span>
			</td>
		<?php elseif ($this->_tpl_vars['keyid'] == '50' || $this->_tpl_vars['keyid'] == '73' || $this->_tpl_vars['keyid'] == '51' || $this->_tpl_vars['keyid'] == '57' || $this->_tpl_vars['keyid'] == '59' || $this->_tpl_vars['keyid'] == '75' || $this->_tpl_vars['keyid'] == '81' || $this->_tpl_vars['keyid'] == '76' || $this->_tpl_vars['keyid'] == '78' || $this->_tpl_vars['keyid'] == '80'): ?> <!--AccountPopup-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=25% class="dvtCellInfo" align="left">&nbsp;<a href="<?php echo $this->_tpl_vars['keyseclink']; ?>
"><?php echo $this->_tpl_vars['keyval']; ?>
</a>
			</td>
		<?php elseif ($this->_tpl_vars['keyid'] == 82): ?> <!--Email Body-->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 colspan="3" width=100% class="dvtCellInfo" align="left">&nbsp;<?php echo $this->_tpl_vars['keyval']; ?>
...
&nbsp;
 ...
 class="dvtCellInfo" align="left">&nbsp;
				...
				<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 colspan="2" class="dvtCellInfo">&nbsp;</td>
			</tr>
			<tr>
				<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 align="right" class="dvtCellLabel">
 ...
 class="dvtCellInfo" align="left" >&nbsp;
		...
		<?php elseif ($this->_tpl_vars['keyid'] == 69): ?><!-- for Image Reflection -->
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 align="left" width=25%">&nbsp;<?php echo $this->_tpl_vars['keyval']; ?>
</td>
		<?php else: ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
