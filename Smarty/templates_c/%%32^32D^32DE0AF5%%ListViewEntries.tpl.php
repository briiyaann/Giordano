<?php /* Smarty version 2.6.18, created on 2014-09-26 11:53:47
...
<form name="massdelete" method="POST" id="massdelete" onsubmit="VtigerJS_DialogBox.block();">
	 <input name="homeowner" type="hidden" id="homeowner" value="<?php echo $this->_tpl_vars['HOMEOWNER']; ?>
">
	 <input name="hmode" type="hidden" id="hmode" value="<?php echo $this->_tpl_vars['HMODE']; ?>
">
	 <input name="hview" type="hidden" id="hview" value="<?php echo $this->_tpl_vars['HVIEW']; ?>
">
