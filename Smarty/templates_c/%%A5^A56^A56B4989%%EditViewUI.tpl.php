<?php /* Smarty version 2.6.18, created on 2014-09-29 11:26:06
...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'EditViewUI.tpl', 34, false),array('modifier', 'getTranslatedString', 'EditViewUI.tpl', 66, false),array('modifier', 'getTranslatedCurrencyString', 'EditViewUI.tpl', 415, false),array('modifier', 'substr', 'EditViewUI.tpl', 472, false),)), $this); ?>
		...
		<?php endif; ?>
				...
				<?php if ($this->_tpl_vars['uitype'] == '__blank__'): ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=20% class="dvtCellLabel" align=right>
			</td>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 ...
 type='hidden' class='small' name="<?php echo $this->_tpl_vars['fldname']; ?>
...
"
			...
			<?php endif; ?>
			<?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
...
","test","width=640,height=602,resizable=0,scrollbars=0,top=150,left=200");' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;
 ...
 type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
"
...
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
		...
		<?php elseif ($this->_tpl_vars['uitype'] == 3 || $this->_tpl_vars['uitype'] == 4): ?><!-- Non Editable field, only configured value will be loaded -->
				<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=20% class="dvtCellLabel" align=right><font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
 <?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small"><?php endif; ?></td>
                                <td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=30% align=left class="dvtCellInfo"><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 readonly type="text" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" name="<?php echo $this->_tpl_vars['fldname']; ?>
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
...
"  onBlur="this.className='detailedViewTextBox'" cols="90" rows="8"><?php echo $this->_tpl_vars['fldvalue']; ?>
				...
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type = "hidden" name="helpdesk_solution" value = '<?php echo $this->_tpl_vars['fldvalue']; ?>
'>
				<?php endif; ?>
			</td>
...
">
						<select <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="assigned_group_id" class="small">';
...
_mass_edit_check" class="small" ><?php endif; ?>
 ...
 width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 readonly name="account_name" style="border:1px solid #bababa;" type="text" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
"><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
...
","test","width=640,height=602,resizable=0,scrollbars=0");' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
 ...
 width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 readonly name="account_name" type="text" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
"><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
" type="hidden" value="<?php echo $this->_tpl_vars['secondvalue']; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
 ...
 width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 readonly name="account_name" id = "single_accountid" type="text" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
"><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
" type="hidden" value="<?php echo $this->_tpl_vars['secondvalue']; ?>
">&nbsp;<img src="<?php echo vtiger_imageurl('select.gif', $this->_tpl_vars['THEME']); ?>
...
","test","width=640,height=602,resizable=0,scrollbars=0");' align="absmiddle" style='cursor:hand;cursor:pointer'>
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" LANGUAGE=javascript onclick='selectContact("false","general",document.QcEditView)' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" LANGUAGE=javascript onclick='selectContact("false","general",document.EditView)' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" LANGUAGE=javascript onclick='selectSalesOrder();' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" LANGUAGE=javascript onclick='selectQuote()' align="absmiddle" style='cursor:hand;cursor:pointer' >&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
" alt="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT']; ?>
" LANGUAGE=javascript onclick='selectPotential()' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
 ...
 width="30%" align=left class="dvtCellInfo">
			<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 style="width:74%;" class = 'detailedViewTextBox' type="text" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" name="<?php echo $this->_tpl_vars['fldname']; ?>
...
" alt="Skype" title="Skype" LANGUAGE=javascript align="absmiddle"></img>
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 class='detailedViewTextBox' type="text" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" name="<?php echo $this->_tpl_vars['fldname']; ?>
...
'); toggleShowHide('currency_class','multiple_currencies');"><?php echo $this->_tpl_vars['APP']['LBL_MORE_CURRENCIES']; ?>
 &raquo;</a>
					...
					<div id="currency_class" class="multiCurrencyEditUI" width="350">
						<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="hidden" name="base_currency" id="base_currency" value="<?php echo $this->_tpl_vars['BASE_CURRENCY']; ?>
" />
						<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="hidden" name="base_conversion_rate" id="base_currency" value="<?php echo $this->_tpl_vars['BASE_CURRENCY']; ?>
" />
...
>
								...
								<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 class="dvtCellInfo" align="left">
									<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 <?php echo $this->_tpl_vars['disable_value']; ?>
...
');">
 ...
 class="dvtCellInfo" align="left">
									<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 disabled=true type="text" size="10" class="small" name="cur_conv_rate<?php echo $this->_tpl_vars['price']['curid']; ?>
" value="<?php echo $this->_tpl_vars['price']['conversionrate']; ?>
">
								</td>
								<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 class="dvtCellInfo" align="center">
									<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 <?php echo $this->_tpl_vars['disable_value']; ?>
...
" type="checkbox" onclick="toggleTime()" >
 ...
 width="30%" align=left class="dvtCellInfo">
					<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="hidden" name="existing_portal" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
">
					<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
" type="checkbox" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
">
				<img <?php echo $this->_tpl_vars['hidingIMG']; ?>
 src="<?php echo vtiger_imageurl('btnL3Calendar.gif', $this->_tpl_vars['THEME']); ?>
...
">
				...
				<?php if ($this->_tpl_vars['uitype'] == 6 && $this->_tpl_vars['QCMODULE'] == 'Event'): ?>
					<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="dateFormat" type="hidden" value="<?php echo $this->_tpl_vars['dateFormat']; ?>
">
				<?php endif; ?>
				<?php if ($this->_tpl_vars['uitype'] == 23 && $this->_tpl_vars['QCMODULE'] == 'Event'): ?>
					<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="time_end" style="border:1px solid #bababa;" size="5" maxlength="5" type="text" value="<?php echo $this->_tpl_vars['time_val']; ?>
">
				<?php endif; ?>
...
><?php echo $this->_tpl_vars['fldlabel'][$this->_sections['combo']['index']]; ?>
				...
				<?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="parent_id_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small" ><?php endif; ?>
			</td>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="30%" align=left class="dvtCellInfo">
...
">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="parent_name" readonly id = "parentid" type="text" style="border:1px solid #bababa;" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
">
				&nbsp;
				<?php if ($this->_tpl_vars['fromlink'] == 'qcreate'): ?>
					<img src="<?php echo vtiger_imageurl('select.gif', $this->_tpl_vars['THEME']); ?>
...
","test","width=640,height=602,resizable=0,scrollbars=0,top=150,left=200");' align="absmiddle" style='cursor:hand;cursor:pointer'>&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="image" src="<?php echo vtiger_imageurl('clear_field.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR']; ?>
...
" LANGUAGE=javascript onClick="this.form.parent_id.value=''; this.form.parent_name.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
		...
		<?php elseif ($this->_tpl_vars['uitype'] == 357): ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="20%" class="dvtCellLabel" align=right>To:&nbsp;</td>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="90%" colspan="3">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
...
" LANGUAGE=javascript onClick="this.form.parent_id.value=''; this.form.parent_name.value=''; return false;" align="absmiddle" style='cursor:hand;cursor:pointer'>
		   ...
		   <tr style="height:25px">
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="20%" class="dvtCellLabel" align=right>CC:&nbsp;</td>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="ccmail" type="text" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'"  value="">
			...
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="20%" class="dvtCellLabel" align=right>BCC:&nbsp;</td>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
...
<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="salutationtype_mass_edit_check" id="salutationtype_mass_edit_check" class="small" ><br />
			<?php endif; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=10% align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="text" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" name="<?php echo $this->_tpl_vars['fldname']; ?>
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
...
_mass_edit_check" class="small"  >
			...
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 colspan="3" width="30%" align=left class="dvtCellInfo">
...
_mass_edit_check" class="small"  disabled >
			...
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 colspan="1" width="30%" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
...
" onchange="validateFilename(this)"/>
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="hidden" name="<?php echo $this->_tpl_vars['fldname']; ?>
...
_mass_edit_check" class="small" ><?php endif; ?>
			...
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width="30%" colspan="3" align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
...
" />
					&nbsp;<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 title="<?php echo $this->_tpl_vars['APP']['LBL_CHANGE_TITLE']; ?>
...
"/>
 ...
 type="hidden" name="id" value=""/>
			<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="text" id="<?php echo $this->_tpl_vars['fldname']; ?>
...
?>
				...
				<?php endif; ?>
				<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 align="right" class="dvtCellLabel" style="border:0px solid red;">
...
>
				...
				<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 class="dvtCellInfo" align="left" style="border:0px solid red;">
					<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
...
')">
		...
		<?php elseif ($this->_tpl_vars['uitype'] == 70): ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=20% class="dvtCellLabel" align=right><font color="red"><?php echo $this->_tpl_vars['requiredAst']; ?>
<?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
 <?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small" ><?php endif; ?></td>
 ...
 width=30% align=left class="dvtCellInfo">
				<input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 disabled=disabled type="text" name="<?php echo $this->_tpl_vars['fldname']; ?>
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
" class=detailedViewTextBox onFocus="this.className='detailedViewTextBoxOn';" onBlur="this.className='detailedViewTextBox';<?php if ($this->_tpl_vars['fldname'] == 'tickersymbol' && $this->_tpl_vars['MODULE'] == 'Accounts'): ?>sensex_info()<?php endif; ?>">
			</td>
		<?php elseif ($this->_tpl_vars['uitype'] == 1001): ?>
			<td <?php echo $this->_tpl_vars['hidingStatField']; ?>
 width=20% class="dvtCellLabel" align=right><font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
(hh:mm:ss)<?php if ($this->_tpl_vars['MASS_EDIT'] == '1'): ?><input <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 type="checkbox" name="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" id="<?php echo $this->_tpl_vars['fldname']; ?>
_mass_edit_check" class="small" ><?php endif; ?></td>
...
" id ="<?php echo $this->_tpl_vars['fldname']; ?>
" value="<?php echo $this->_tpl_vars['fldvalue']; ?>
" class=detailedViewTextBox style="width:70%" onFocus="this.className='detailedViewTextBoxOn'" onBlur="this.className='detailedViewTextBox'">
				<select <?php echo $this->_tpl_vars['forcedisableStat']; ?>
 name="<?php echo $this->_tpl_vars['fldname']; ?>
_ampm" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" class="small">
				<?php $_from = $this->_tpl_vars['maindata'][3][1]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['arr']):
?>
					<?php if ($this->_tpl_vars['arr'][0] == $this->_tpl_vars['APP']['LBL_NOT_ACCESSIBLE']): ?>
					<option value="<?php echo $this->_tpl_vars['arr'][0]; ?>
