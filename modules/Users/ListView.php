...
//ed edited for surpreme admin only //index.php
if($current_user->isSupreme){
	$smarty->assign("AddNewUser",1);
}
//ed edited end
...
//ed edited removing nextixadmin in query
if(!$current_user->isSupreme){
	$list_query .= " AND vtiger_users.user_name != 'nextixadmin' ";
}
//ed edited
